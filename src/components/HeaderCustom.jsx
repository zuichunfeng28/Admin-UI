...
import avater from '../style/imgs/2.jpg';
           ...
           <Header className="custom-theme header">
               {
                   responsive.data.isMobile ? (
                       <Popover content={<SiderCustom path={path} popoverHide={this.popoverHide}/>}
                                trigger="click" placement="bottomLeft" visible={this.state.visible} onVisibleChange={this.handleVisibleChange}>
               ...
               <Menu mode="horizontal" style={{ lineHeight: '64px', float: 'right'}} onClick={this.menuClick}>
                     ...
                     <Menu.Item key="full" onClick={this.screenFull}>
                           <Icon type="arrow-alt" onClick={this.screenFull}/>
                     </Menu.Item>
                     <Menu.Item key="1">
