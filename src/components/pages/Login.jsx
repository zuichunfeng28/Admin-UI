...
class Login extends React.Component{
     ...
     gitHub = () => {
          window.location.href = 'https://github.com/login/oauth/authorize?client_id=792cdcd244e98dcd2dee&redirect_uri=http://localhost:8000/&scope=user&state=reactAdmin';
     };
