...
import { Tabs, Row, Col, Card, Icon, Radio, Button } from 'antd';
                   ...
                   <Row gutter={16}>
                        <Col className="gutter-row" md={12}>
                             <div className="gutter-box">
                                  <Card bordered={false} title="基本-默认选中第一项">
                             ...
                             <div className="gutter-box">
                                   <Card title="带图标" bordered={false}>
                                       <Tabs defaultActiveKey="2" style={{ height: 150 }}>
                                            <TabPane tab={<span><Icon type="apple"></Icon>Tab 1</span>} key="1">
                                                    Tab1
                                            </TabPane>
                                            <TabPane tab={<span><Icon type="android"></Icon>Tab 2</span>} key="2">
                                                    Tab2
                                            </TabPane>
                                       </Tabs>
                                   </Card>
