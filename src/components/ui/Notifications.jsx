...
import { Select, notification, Button, Icon, Row, Col, Card } from 'antd';
...
export default class Notifications extends React.Component{
    ...
    close = () => {
        console.log('Notification was closed. Enter the close button was clicked or duration time elapsed.');
    };
            ...
            <div className="gutter-example button-demo">
                ...
                <Row gutter={16}>
                     ...
                     <Col className="gutter-row" md={12}>
                         <div className="gutter-box">
                               <Card bordered={false}>
                                    <Select defaultValue="topRight" style={{ width: 120, marginRight: 10}} onChange={ (val) => {
                                            notification.config({
                                                placement: val,
                                            });
                                          }}>
