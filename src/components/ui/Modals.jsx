                                 ...
                                 <Card bordered={false}>
                                      ...
                                      <p>
                                          ...
                                          <Modal title="Title of the modal dialog" visible={this.state.visible2}
                                                 onOk={this.handleOk2} confirmLoading={this.state.confirmLoading2}
                                      ...
                                      <p>
                                          ...
                                          <Modal visible={this.state.visible3} title="Title"
                                                  onOk={this.handleOk2} onCancel={this.handleCancel3}
                                                  footer={[
                                                      <Button key="back" size="large" onClick={this.handleCancel3}>Return</Button>,
                                                      <Button key="submit" size="large" loading={this.state.loading3} onClick={this.handleOk3}>Submit</Button>
                                                  ]}>
                                                    <p>Some contents...</p>
                                                    <p>Some contents...</p>
                                                    <p>Some contents...</p>
