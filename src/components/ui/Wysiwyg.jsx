                        ...
                        <Col className="gutter-row" md={24}>
                            <div className="gutter-box">
                                  <Card title="富文本编辑器" bordered={false}>
                                        <Editor editorState={editorState} toolbarClassName="home-toolbar"
                                                wrapperClassName="home-wrapper" editorClassName="home-editor"
                                                onEditorStateChange={this.onEditorStateChange} onContentStateChange={this.onEditorChange}
                                                toolbar = { {
                                                ...
                                                placeholder="请输入正文~~尝试@哦,有惊喜!!" spellCheck
