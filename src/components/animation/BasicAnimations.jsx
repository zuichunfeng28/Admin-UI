...
import { Row, Switch, Col, Card } from 'antd';

 export default class BasicAnimations extends React.Component{
                        ...
                        {animations.map((val,i) => (
                            <Col className="gutter-row" md={6} key={i}>
                                 <div className="gutter-box">
                                      <Card className={`${this.state.animated || (this.state.animatedOne === i) ? 'animated' : ''} ${this.state.animated || (this.state.animatedOne === i) ? 'infinite' : ''} ${val}`}
