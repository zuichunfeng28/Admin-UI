...
import { Form, Select, Row, Col, Card, Input, Tooltip, Icon, Cascader, Button, Checkbox } from 'antd';
                              ...
                              <div className="gutter-box">
                                    <Card title="注册表单" bordered={false}>
                                         <Form onSubmit={this.handleSubmit}>
                                              ...
                                              <FormItem {...formItemLayout} label="常驻地址">
                                                     {getFieldDecorator('residence',{
                                                         initialValue: ['sichuan', 'Aba', 'jiuzhaigou'],
                                                         rules: [{ type: 'array', required: true, message: '请选择您的常住地址!!'}],
                                                     })(
